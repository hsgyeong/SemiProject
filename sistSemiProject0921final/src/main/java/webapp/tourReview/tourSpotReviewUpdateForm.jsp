...
function showStarAvg(){
	document.getElementById('staravgid').style.visibility='visible';	
}
...
$(function(){
 ...
 TourReviewDto dto = dao.getData(com_seq);
...
%>
   <form action="tourReview/tourSpotReviewUpdateAction.jsp" method="post"
      enctype="multipart/form-data">
      <input type="hidden" name="com_seq"  value="<%=com_seq%>" com_seq="<%=com_seq%>">
   ...
   success:function(res){
      ...
      $("#selDay").on("change",function(){
             ...
             $.ajax({
            	...
            	success:function(r){
            		var p="<img src='jeju/"+r.photo+"' style='width:180px;height:180px;border-radius:20px;margin-left:80px'>";
            		$("#sel3").html(p);
            		$("#avg").text(r.avg);
            		showStarAvg();
            	}
...
%>
                  ...
                  <div id="sel2"></div>
                  <div id="sel3"></div>
                <span id="staravgid" style="visibility: hidden;"><div id="staravg"><span id="avgstyle">평균 별점</span>&nbsp;<div id="avg"></div>&nbsp;점</div></span>
               ...
               <button class="btn btn-outline-dark" type="submit"
                  style="margin-top: 10px; width:60px;margin-left: 1050px; border-color: #696969;">수정</button>
   </td>
   </tr>
