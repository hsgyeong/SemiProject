                  ...
                  var divs = document.querySelectorAll('div.d');
                     ...
                     <div class="col-md-4 text-end">
                        ...
                        if(loginok!=null&&tourreviewdto.getId().equals(myid)){%> 
                         <a href="tourReview/tourSpotReviewDelete.jsp?com_seq=<%=tourreviewdto.getCom_seq()%>&currentPage=<%=currentPage%>"
                       style="color: red">
                       <i class="bi bi-trash3 del" style="color: red; cursor: pointer; float:right; font-size:20px" com_seq=<%=tourreviewdto.getCom_seq() %>></i></a>
                     <a href="index.jsp?main=tourReview/tourSpotReviewUpdateForm.jsp?com_seq=<%=tourreviewdto.getCom_seq()%>&currentPage=<%=currentPage%>"
                     style="color: green">
                     <i class="bi bi-pencil-square up"  style="color: green; cursor: pointer; float:right; font-size:20px" com_seq=<%=tourreviewdto.getCom_seq() %>></i>
                     </a>
                      <%}%>
                              <span class="likes">
